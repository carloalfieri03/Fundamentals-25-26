...
class ConvBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        #x = self.pool(x)
        return x
    #### pooling is excluded to avoid excessive information loss
### CAA classe nuova
...
class DecoderWrapper(nn.Module):
    def __init__(self, in_channels, layer_widths, kernel_size, stride=2, output_padding=1, use_batchnorm=False):
        """
        Args:
